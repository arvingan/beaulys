    ...
    if (a) {
        $.ajax({
            ...
            success: function(a) {
                ...
                $("#asset_ul").html(e);
                $('.gouwuche').html(getCookie("cart_count"))
                return false
            }
        })
    } else {
